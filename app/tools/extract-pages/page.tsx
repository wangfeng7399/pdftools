...
export default function ExtractPagesPage() {
  ...
  const handleExtract = async () => {
    ...
    if (!pageIndices.trim()) {
      toast.error("Please enter the page indices to extract")
      return
    }
    ...
    <div className="min-h-screen bg-background">
      <div className="container py-8 mx-auto">
        ...
        <div className="max-w-3xl mx-auto">
          <Card className="p-6">
            <h1 className="text-3xl font-bold mb-2 text-center">Extract PDF Pages</h1>
            <p className="text-muted-foreground mb-6 text-center">
              Extract specified pages from a PDF file and create a new PDF
            </p>
            ...
            <div className="space-y-4">
              ...
              <div>
                <Label htmlFor="page-indices" className="mb-2 block">
                  Page Indices to Extract
                </Label>
                <Input
                  id="page-indices"
                  value={pageIndices}
                  onChange={(e) => setPageIndices(e.target.value)}
                  placeholder='e.g., [0,1,2] to extract pages 1, 2, 3 (indices start from 0)'
                  disabled={isProcessing}
                />
                <p className="text-xs text-muted-foreground mt-2">
                  Use JSON array format, e.g., [0,1,2] or [5,6,7,8]
                </p>
              </div>
